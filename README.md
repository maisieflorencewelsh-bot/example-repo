...
The interest will then be calculated depending on their input/choice of interest.
If the user chooses bond, it will prompt the user to enter the current value of the house, interest rate and the length of the mortgage (in months). The repayment per month will be calculated using these values.